...
6. **A6 Action** — `Apply leave for EMP001 from 2026-09-20 to 2026-09-22 for personal reasons.` -> `apply_leave`, 3 inclusive days, 12 -> 9, exactly one record. Save returned `conversation_id`.
